...
public class TestController {
    ...
    public String testUsers() {
        ...
        try {
            Utilisateur user = utilisateurService.findByEmail("tototiti@gmail.com");
        ...
        try {
            ...
            result.append("\n✅ Admin existe déjà: ").append(adminExists.getEmail()).append("\n");
        } catch (Exception e) {
            try {
    ...
    public String testValidateEmail(@RequestParam("email") String email) {
        ...
        try {
            ...
            // Vérifier s'il dirige déjà un club
